...
**Step 5 — Connector Expansion 진행 중** (2026-05-14 기준). Steps 1–4 + Step 5.1 RDBMS 일부(MySQL, SQLite)까지 완료. **321 단위 + 3 skip + 111 통합 = 435 테스트** all green, **18 ADR**.
...
- 📋 Step 7 (Service Foundation): ADR-0017 채택, 세부 기술 스택 ADR-0019~0023은 Step 7.0에서 확정 예정 (ADR-0018은 디자인 시스템에 이미 사용됨) — 미착수

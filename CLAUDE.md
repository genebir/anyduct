...
- 🔄 Step 9 (Execution Engine 통합):
  ...
  - 9.2 미착수 — 스케줄러 tick(active schedules → pending Run 생성). cron 검증은 Step 8.5e에서 끝남
  ...
  - 9.3b 미착수 — heartbeat-during-execution + ZombieReaper(stuck running → 회수)

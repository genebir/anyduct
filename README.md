...
🌐 **[소개 사이트 (랜딩 페이지)](https://genebir.github.io/ETL/)**
...
SaaS ETL은 자사 플랫폼에, dbt는 SQL 변환에, Airflow는 오케스트레이션에 머뭅니다. anyduct는 이들의 장점을 하나로 모읍니다. 자세한 비교는 [소개 사이트](https://genebir.github.io/ETL/#different)를 참고하세요.
...
```bash
git clone git@github.com:genebir/ETL.git && cd ETL
...
```bash
git clone https://github.com/genebir/ETL && cd ETL
uv sync

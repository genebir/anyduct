...
**Steps 1–4 + Step 5.1(MySQL/SQLite) + Step 5.3(MongoDB) + Step 5.7(HTTP) + Step 7.0~7.4 + Step 8 전체 + Step 9.2(scheduler) + Step 9.3a + Step 9.3b(heartbeat + zombie reaper) 완료. 코어 374 unit + 서버 65 unit + 3 skip + 코어 153 it + 서버 223 it = 818 테스트, 24 ADR.**
...
- [ ] Sidebar / Header / ConnectionForm stories (provider mock 필요)

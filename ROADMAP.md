...
**Steps 1–4 + Step 5.1(MySQL/SQLite) + Step 7.0~7.4 + Step 8.1~8.4 + Step 8.5a/b/c/d 완료. 코어 344 unit + 서버 65 unit + 3 skip + 코어 119 it + 서버 145 it = 676 테스트, 24 ADR.**

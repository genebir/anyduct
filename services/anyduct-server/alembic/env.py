...
``target_metadata``는 ``anyduct_server.db.Base.metadata`` — 모든 모델은
``anyduct_server.db.models`` 한 곳에서 import되어 자동 등록된다.
"""
...
from anyduct_server.db.models import (  # noqa: F401 — side-effect import for metadata registration
    AuditLog,
    Membership,
    PersonalAccessToken,
    Pipeline,

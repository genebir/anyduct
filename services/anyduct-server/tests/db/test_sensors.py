...
import anyduct_server.sensors.builtins  # noqa: F401 — service-side (asset_freshness)
import httpx
import pytest
...
from anyduct_server.dependencies import get_secret_backend_dep, get_session, get_session_factory
from anyduct_server.sensors import SensorRepository, SensorScheduler
from anyduct_server.sensors.builtins.asset_freshness import AssetFreshnessSensor
from anyduct_server.sensors.builtins.dataset_row_count import DatasetRowCountSensor
from anyduct_server.sensors.builtins.file_landed import FileLandedSensor
from anyduct_server.sensors.builtins.lineage_arrival import LineageArrivalSensor
...
async def test_create_duplicate_name_raises(session: AsyncSession) -> None:
    from anyduct_server.sensors.repository import SensorNameTakenError
...
async def test_create_unknown_type_raises(session: AsyncSession) -> None:
    from anyduct_server.sensors.repository import UnknownSensorTypeError
...
async def test_file_landed_fires_when_matching_object_lands(
    ...
    monkeypatch.setattr(
        "anyduct_server.sensors.builtins.file_landed._build_s3_client",

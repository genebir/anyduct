...
import pytest
from anyduct_server.settings import Environment, Settings, get_settings
...
def test_install_openlineage_returns_none_when_url_absent(
    ...
    from anyduct_server.cli import _install_openlineage_emitter
    from anyduct_server.settings import get_settings as _get_settings

...
export const en = {
  ...
  "erdDesign.dialect": "SQL dialect",
  "erdDesign.columnTypeAria": "Column type",
  "erdShape.add": "Shape…",
  "erdShape.rect": "Box",
  "erdShape.text": "Memo",
  "erdShape.memo": "Memo",
  ...
  // pipelines list
  // Bulk multi-select (2026-06-12) — mirrors the migrations surface.
  "pipelines.selectAllVisibleAria": "Select all visible pipelines",
  "pipelines.selectRowAria": "Select {name}",
  "pipelines.selectedCount": "{n} selected",
  "pipelines.clearSelection": "Clear",
  "pipelines.dryRunSelected": "Dry run",
  "pipelines.dryRunSelectedHint": "Validate connections/secrets for every selected pipeline before running.",
  "pipelines.runSelected": "Trigger",
  "pipelines.deleteSelected": "Delete",
  "pipelines.bulkDryRunOk": "Dry run passed for {n} pipelines",
  "pipelines.bulkDryRunPartial": "Dry run: {ok} passed, {fail} failed",
  "pipelines.bulkRunQueued": "{n} runs queued",
  "pipelines.bulkRunPartial": "{ok} queued, {fail} skipped/failed (unsaved or broken pipelines are skipped)",
  "pipelines.bulkDeleted": "{n} pipelines deleted",
  "pipelines.bulkDeletePartial": "{ok} deleted, {fail} failed",
  "pipelines.bulkDeleteTitle": "Delete {n} pipelines?",
  "pipelines.bulkDeleteDesc": "All versions and schedules are removed; runs stay for audit.",
  ...
  "pipelines.needConnectionFirst": "Add a connection to this workspace before creating an orchestration pipeline — every step needs one.",
  "pipelines.deleted": "Deleted {name}",
  "pipelines.deleteFailed": "Couldn't delete pipeline.",
  "pipelines.runQueued": "Run queued for {name}",
  "triggerParams.title": "Run {name} with parameters",
  "triggerParams.desc": "Override this run's parameters. Values are parsed as JSON when possible (e.g. 100, [\"a\"]), else kept as text. They template into the config via {{ params.x }}.",
  "triggerParams.run": "Run",
...
export const ko: Messages = {
  ...
  "erdDesign.dialect": "SQL 방언",
  "erdDesign.columnTypeAria": "컬럼 타입",
  "erdShape.add": "도형…",
  "erdShape.rect": "박스",
  "erdShape.text": "메모",
  "erdShape.memo": "메모",
  ...
  // 일괄 선택 (2026-06-12) — 마이그레이션 surface 미러.
  "pipelines.selectAllVisibleAria": "보이는 파이프라인 모두 선택",
  "pipelines.selectRowAria": "{name} 선택",
  "pipelines.selectedCount": "{n}개 선택됨",
  "pipelines.clearSelection": "선택 해제",
  "pipelines.dryRunSelected": "Dry run",
  "pipelines.dryRunSelectedHint": "선택한 파이프라인 전체의 연결/시크릿을 실행 전에 검증합니다.",
  "pipelines.runSelected": "실행",
  "pipelines.deleteSelected": "삭제",
  "pipelines.bulkDryRunOk": "{n}개 파이프라인 dry run 통과",
  "pipelines.bulkDryRunPartial": "Dry run: {ok}개 통과, {fail}개 실패",
  "pipelines.bulkRunQueued": "{n}개 run이 큐에 추가됨",
  "pipelines.bulkRunPartial": "{ok}개 큐 추가, {fail}개 건너뜀/실패 (미저장·깨진 파이프라인은 건너뜀)",
  "pipelines.bulkDeleted": "{n}개 파이프라인 삭제됨",
  "pipelines.bulkDeletePartial": "{ok}개 삭제, {fail}개 실패",
  "pipelines.bulkDeleteTitle": "{n}개 파이프라인을 삭제할까요?",
  "pipelines.bulkDeleteDesc": "모든 버전과 스케줄이 함께 삭제됩니다. run 기록은 감사를 위해 남습니다.",
  ...
  "pipelines.needConnectionFirst": "오케스트레이션 파이프라인을 만들기 전에 이 워크스페이스에 연결을 먼저 추가하세요 — 모든 스텝에 연결이 필요합니다.",
  "pipelines.deleted": "{name} 삭제됨",
  "pipelines.deleteFailed": "파이프라인을 삭제할 수 없습니다.",
  "pipelines.runQueued": "{name} 실행이 큐에 추가됨",
  "triggerParams.title": "{name} 파라미터 지정 실행",
  "triggerParams.desc": "이번 실행의 파라미터를 덮어씁니다. 값은 가능하면 JSON으로 해석(예: 100, [\"a\"]), 아니면 문자열. config에 {{ params.x }}로 주입됩니다.",
  "triggerParams.run": "실행",

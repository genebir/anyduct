...
cron validation lives in :func:`etlx_server.schedules.repository.validate_cron_for_mode`
...
from etlx_server.db.enums import PipelineMode, WorkspaceRole
from etlx_server.db.models import Schedule
from etlx_server.dependencies import get_session
from etlx_server.pipelines.repository import PipelineRepository
from etlx_server.schedules.repository import (
    InvalidCronError,
    ScheduleRepository,
)

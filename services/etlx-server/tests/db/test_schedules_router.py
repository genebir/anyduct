...
from etlx_server.db.enums import AuthMethod, PipelineMode, WorkspaceRole
from etlx_server.db.models import AuditLog, Membership, Pipeline, User, Workspace
...
async def test_update_unknown_field_via_repository_rejected(
    ...
    from etlx_server.schedules.repository import ScheduleRepository

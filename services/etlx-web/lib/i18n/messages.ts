...
export const en = {
  ...
  "erdDesign.areaAll": "All",
  "erdDesign.areaAdd": "Add subject area",
  "erdDesign.areaDelete": "Remove tab",
  "erdDesign.areaDeleteTitle": "Remove the \"{name}\" tab?",
  "erdDesign.areaDeleteDesc": "Only the tab grouping is removed — its tables stay in the model (All tab).",
  ...
  "erdDesign.confirmRemoveFromAreaDesc": "Tables are only removed from this subject-area tab; they stay in the model (All tab). Relationship lines are deleted from the model.",
...
export const ko: Messages = {
  ...
  "erdDesign.confirmRemoveFromAreaDesc": "테이블은 이 주제영역 탭에서만 제거되며 모델(전체 탭)에는 남습니다. 관계선은 모델에서 삭제됩니다.",
